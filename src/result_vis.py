...
if __name__ == "__main__":
    ...
    x = np.linspace(-x_range, x_range, OBSERVATION_SPACE_SHAPE[0])
    y = np.linspace(-y_range, y_range, OBSERVATION_SPACE_SHAPE[1])
    r = np.linspace(-r_range, r_range, OBSERVATION_SPACE_SHAPE[2])
